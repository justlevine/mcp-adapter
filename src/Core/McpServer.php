...
class McpServer {
	 ...
	 * @param class-string<\WP\MCP\Core\McpObservabilityHandlerInterface>|null $observability_handler Observability handler class to use (e.g., NullMcpObservabilityHandler::class). Must implement McpObservabilityHandlerInterface. If null, NullMcpObservabilityHandler will be used.
	...
	public function __construct(
		...
		if ( ! is_callable( $transport_permission_callback ) ) {
	...
	private function create_transport_context(): McpTransportContext {
		...
		$router_context = new McpTransportContext(
			...
			null,
			$this->transport_permission_callback
		);
